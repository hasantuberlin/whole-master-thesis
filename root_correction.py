...
if __name__ == "__main__":
    ...
    #
    #train_test_data_path_wiki_table
    wiki_data_path_table="datasets/wiki_old/"
    ...
    #print("Hospital Data: edit distance domain")
    ...
    #print("Tax Data edit distance general")
    #app.error_correction_edit_distance_retrain("real_world",clean_data_path_tax,dirty_data_path_tax,"edit_distance_general")
    ...
    #print("Tax Data: edit distnace domain")
    #app.error_correction_edit_distance_retrain("real_world",clean_data_path_tax,dirty_data_path_tax,"edit_distance_domain")
    #
    #
    #app.error_correction_edit_distance_retrain("real_world",clean_data_path_tax,dirty_data_path_tax, "edit_distance_domain")
   ...
   # print("Tax: fasttext general")
   # app.error_correction_fasttext_with_retrain_realworld("real_world",clean_data_path_tax,dirty_data_path_tax, "Fasttext_All_Domain")


    #
    #
    #
    #retrain with edit distnace and fastext
    #print(" Tax Data")


    #app.retrain_edit_fasttext_realworld_domain("real_world",clean_data_path_tax,dirty_data_path_tax, "general")
   # print("Tax: domain edit + fasttext")
    #app.retrain_edit_fasttext_realworld_domain("real_world",clean_data_path_tax,dirty_data_path_tax, "domain")
   # print("Tax: general edit + fasttext")
   # app.retrain_edit_fasttext_realworld_domain("real_world",clean_data_path_tax,dirty_data_path_tax, "general")
