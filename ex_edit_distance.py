...
class Experiments:
    ...
    def __init__(self):
        ...
        self.DATASETS=["wiki","tax","hospital","flights"]
    ...
    def experiment_general(self):
        ...
        for dataset_name in self.DATASETS:
            if dataset_name=="wiki":
                ...
                test_data_path = os.path.join("datasets", dataset_name,"general.csv")
                if not os.path.exists(test_data_path):
                    print("test data path not exits!")
                    error_correction=prepare_testing_datasets_real_world_general_general(dirty_data,clean_data,"general",dataset_name)
                else:
