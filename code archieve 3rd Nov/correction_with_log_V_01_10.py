...
class Jharu:
    ...
    def evaluate_model (self,model_type,total_error, total_error_to_repair, total_correction):
        ...
        logfile_name=model_type+ str(n)+".log"
        logging.basicConfig(filename=logfile_name, level=logging.INFO)
            ...
            if rf.endswith(".json"):
                try:
                    ...
                    for one_item in revision_list:
                        ...
                        if old_value and new_value and old_value !=" " and new_value!=" ":
...
if __name__ == "__main__":
    ...
    #print("Edit distance Correction: Genral")
    #print("Wiki Data")
    ...
    #app.error_correction_fasttext_with_retrain_realworld("real_world",clean_data_path,dirty_data_path, "Fasttext_All_Domain")
    #
    #retrain fasttext domain with hospital data
    #app.error_correction_fasttext_with_retrain_realworld("real_world",clean_data_path,dirty_data_path, "Fasttext_Domain_Location")
