                ...
                for model in self.MODELS:
                    if model=="Edit_Distance_G":
                        ...
                        if not error_correction.empty:
                            ...
                            p,r,f,cfe=error_correction_supervised_fasttext_edit_distance_02_equality_check(model,error_correction,retrain_data,dataset_name,total_error,dirty_data,clean_data,"general")
